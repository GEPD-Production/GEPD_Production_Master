...
title: "Policy Survey"
author: "Brian Stacy"
Last updated: "Mohammed Eldesouky (Dec 13, 2024)"
date: "`r Sys.Date()`"
...
file_name <- 'GEPD Policy Survey - Bangladesh DS.xlsx'


if (str_to_lower(Sys.getenv("USERNAME")) == "wb589124" ){
  #project_folder  <- "//wbgfscifs01/GEDEDU/datalib-edu/projects/gepd"
  project_folder  <- "C:/Users/wb589124/WBG/HEDGE Files - HEDGE Documents/GEPD-Confidential/General/Country_Data"
  expert_dir <-file.path(paste(project_folder,"GEPD_Production-Bangladesh/01_GEPD_raw_data/Policy_Survey", sep="/"))
  save_dir <-file.path(paste(project_folder,"GEPD_Production-Bangladesh/03_GEPD_processed_data/Policy_Survey", sep="/"))

} else if  (str_to_lower(Sys.getenv("USERNAME")) == "wb589124" ){
  #project_folder  <- "//wbgfscifs01/GEDEDU/datalib-edu/projects/gepd"
  project_folder  <- "C:/Users/wb589124/WBG/HEDGE Files - HEDGE Documents/GEPD-Confidential/General/Country_Data"
  expert_dir <-file.path(paste(project_folder,"GEPD_Production-Bangladesh/01_GEPD_raw_data/Policy_Survey", sep="/"))
  ...
  #project_folder  <- "//wbgfscifs01/GEDEDU/datalib-edu/projects/gepd"
  project_folder  <- "C:/Users/wb469649/WBG/HEDGE Files - HEDGE Documents/GEPD-Confidential/General/Country_Data"
  expert_dir <-file.path(paste(project_folder,"GEPD_Production-Bangladesh/01_GEPD_raw_data/Policy_Survey", sep="/"))
  save_dir <-file.path(paste(project_folder,"GEPD_Production-Bangladesh/03_GEPD_processed_data/Policy_Survey", sep="/"))
...
write_dta(expert_dta_final,path=paste(save_dir, 'expert_dta_final.dta', sep="/"))
```
